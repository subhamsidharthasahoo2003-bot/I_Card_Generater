  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-mono text-[6.5px] text-neutral-400 tracking-wider">
          ENCODED CHIP
        </span>
      </div>

      {/* Main Body: White with Black Typography & Orange Highlights */}
      <div className="flex-1 px-3 py-1 flex flex-col justify-between text-[7px] bg-white">
        {/* Company & Contact Section */}
        <div className="border-b border-neutral-200 pb-1">
          <p className="font-black text-[9px] text-black tracking-tight leading-tight">
            {company.name}
          </p>
          <p className="text-[6.5px] text-neutral-700 leading-tight mt-0.5 flex items-center gap-1">
            <MapPin className="w-2 h-2 text-orange-600 shrink-0" />
            <span className="truncate">{company.address}</span>
          </p>
          <div className="flex items-center gap-3 text-[6px] text-neutral-600 mt-0.5 font-medium">
        ...
        <div className="grid grid-cols-2 gap-2 my-0.5">
          ...
          {/* Signature Box */}
          <div className="flex flex-col items-center justify-end border border-dashed border-neutral-400 rounded-xs p-1 bg-neutral-50">
            {company.authorizedSignatureUrl ? (
              ...
              <div className="h-[6mm] flex items-center font-serif italic text-[8px] text-black font-black">
                Auth. Signatory
              </div>
            )}
            <div className="w-full border-t border-orange-500 text-center mt-0.5">
              <span className="text-[5.5px] text-neutral-600 block leading-tight font-bold">
        ...
        <div className="bg-orange-50 border border-orange-300 rounded-xs p-1 flex items-start gap-1">
          <ShieldAlert className="w-2.5 h-2.5 text-orange-600 shrink-0 mt-0.5" />
          <p className="text-[6px] text-black font-medium leading-snug">
      ...
      <div className="bg-black px-3 py-0.5 flex items-center justify-between text-[6px] text-white font-bold border-t border-orange-500">
